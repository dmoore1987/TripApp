app.factory('SearchService', ['$http', '$q', '$rootScope', '$window', function ($http, $q, $rootScope, $window) {
    ...
    var search = function () {
       ...
       var placesList = [];
        ...
        $http({
            url: 'http://api.openweathermap.org/data/2.5/forecast/daily?q=' + $rootScope.loc + '&mode=json&units=metric&cnt=7',
            method: 'GET'
       ...
       //var googlePlacesDeferred = $q.defer();
        $http({
            url: 'https://maps.googleapis.com/maps/api/place/textsearch/json?&query="tourist attractions in ' + $rootScope.loc + '"&key=AIzaSyBKLw7xomUeuWhxLC9L71lfCBuamTI9K58',
            ...
            $rootScope.data2 = placesList.slice(0,3);
        ...
        //$http({
        //    url: 'http://maps.googleapis.com/maps/api/staticmap?center=' + $rootScope.loc + '&zoom=14&size=512x512&maptype=roadmap&markers=color:blue%7clabel:s%7c40.702147,-74.015794&markers=color:green%7clabel:g%7c40.711614,-74.012318&markers=color:red%7ccolor:red%7clabel:c%7c40.718217,-73.998284&sensor=false&key=AIzaSyDbszI8Gfk1cwKbHfq87Ho9Yl2vv_6fMN0',
        //    method: 'GET'
        //}).success(function (data) {
